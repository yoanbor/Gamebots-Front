const RegisterAndLoginLeftPart = () => {
    return (
        <div className="left-part">
            <img src={"../../public/avatars/AvatarBang.png"} id={"avatar-Bangalore"} className={"img-avatars"}
                 alt="Avatar Bangalor"/>
            <img src={"../../public/avatars/AvatarBlood.png"} id={"avatar-Bloodhunt"} className={"img-avatars"}
                 alt="Avatar Bloodhunt"/>
            <img src={"../../public/avatars/AvatarLifeline.png"} id={"avatar-Lifeline"} className={"img-avatars"}
                 alt="Avatar Lifeline"/>
            <img src={"../../public/avatars/AvatarPath.png"} id={"avatar-Pathfinder"} className={"img-avatars"}
