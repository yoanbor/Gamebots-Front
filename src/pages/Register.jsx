...
function Register() {
  ...
  const handleTogglePassword2 = () =>
    togglePassword(passwordInput2, setInputType2);
      ...
      <div className="register-right-part">
        ...
        <div className="form-container">
          ...
          >
            ...
            <div className="field field-password">
              <label className="labels">
                <p className="label" id="label-confirmPassword">
            ...
            <label className="checkbox">
              ...
              <NavLink to={'/CGU'} id="CGU">
                {' '}
                Conditions Générales d’Utilisations
              </NavLink>{' '}
              et les
              <NavLink to={'/MentionsLegales'} id="mentionsLegales">
                {' '}
                Mentions Légales
              </NavLink>
            </label>
        ...
        <p>
          ...
          <NavLink to={'/Login'} id="need-to-login">
            {' '}
            Connectez vous
          </NavLink>
        </p>
