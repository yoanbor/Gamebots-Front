        ...
        <div className={"login"}>
            ...
            <div className="login-right-part">
                ...
                <div className="form-container">
                    <form className={"form"} onSubmit={(e) => handleSubmitForLogin(e, pseudo, password, setPseudo, setPassword, navigate, setError)}>
                        <label className="labels">
                            <p className='label' id="label-pseudo">Pseudo</p>
                            <input type="text" className="inputs" required placeholder="Herobrine"
                                   autoComplete="username" value={pseudo} onChange={(e) => setPseudo(e.target.value)} />
                        </label>
