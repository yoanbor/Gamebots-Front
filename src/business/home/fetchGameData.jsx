...
import getImageBannerByGameIdController from "../../controllers/image/GetImageBannerByGameIdController";
    ...
    try {
        ...
        const games = await Promise.all(result.map(async (gameData) => {
            ...
            try {
                ...
                console.error(`Erreur lors de la récupération de la bannière pour le jeu ${game.title}`, error);
            }
